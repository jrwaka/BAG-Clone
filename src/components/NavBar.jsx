...
function NavBar() {
  ...
  return (
    <div>
      <nav className="flex  justify-between items-center fixed top-0 z-50 lg:left-24 lg:right-24 px-8 py-2 md:rounded-b-[2rem] md:text-xs lg:text-[16px] text-xs left-0 right-0 rounded-none border border-gray-200 bg-white">
